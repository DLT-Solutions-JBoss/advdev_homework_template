...
oc create secret docker-registry nexus-registry-secret -n ${GUID}-tasks-prod --docker-email="rick.stewart@dlt.com" --docker-server="nexus-registry-gpte-hw-cicd.apps.na311.openshift.opentlc.com" --docker-username=admin --docker-password=redhat
